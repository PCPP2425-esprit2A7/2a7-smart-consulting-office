...
Client::Client(int id, QString nomComplet, QString adresse, QString telephone, QString email, QString nomEntreprise, int nbrConsultations, QDate joinDate, QString cinClient)
{
    this->id = id;
...
{
    QSqlQuery query;
    query.prepare("INSERT INTO CLIENTS (NOMCOMPLET, ADRESSE, TELEPHONE, EMAIL, NOMENTREPRISE, NBR_CONSULTATIONS, JOIN_DATE, CIN_CLIENT) "
                  "VALUES (:nomComplet, :adresse, :telephone, :email, :nomEntreprise, :nbrConsultations, :joinDate, :cinClient)");
